...
Page({
    ...
    async onLoad() {
        console.log(`collapseData:`, this.data.collapseData)
    ...
    async getAgendaArray() {
        ...
        //
        // console.log(`getAgendaArray agendaList:`, agendaList);
        // console.log(`getAgendaArray this.data.collapseData:`, this.data.collapseData);
    },
